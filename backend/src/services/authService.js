...
async function login(req, res) {
    ...
    res.cookie("app1_access_token", access_token, {
        httpOnly: true,       
        secure: false,         
        sameSite: "Lax",       
        maxAge: 300 * 1000
    ...
    res.cookie("app1_refresh_token", refresh_token, {
        httpOnly: true,       
        secure: false,         
        sameSite: "Lax",       
...
async function token_refresh(req, res) {
    ...
    const refresh_token = req.cookies.app1_refresh_token;
...
async function logout(req, res) {
    res.clearCookie("app1_access_token");
    res.clearCookie("app1_refresh_token");
